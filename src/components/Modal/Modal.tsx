...
export function Modal({
  ...
  const dialogClass = `box-border flex flex-col w-full bg-white rounded-md overflow-hidden outline-none font-[var(--font-main)] shadow-[0_8px_16px_-4px_rgba(9,30,66,0.25),0_0_0_1px_rgba(9,30,66,0.06)] ${isBlanketHidden ? 'pointer-events-auto' : ''} ${sizeClass} ${dialogMaxHeight}`.trim();
