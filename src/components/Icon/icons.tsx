...
export const icons = {
  ...
  // navigation chrome — exported from Figma at native 20×20 (see iconViewBox)
  'sidebar-collapse': <>
    <path d="M14.125 3.75V3V3.75ZM14.562 5.938C14.562 6.352 14.899 6.688 15.312 6.688C15.726 6.688 16.062 6.352 16.062 5.938H15.312H14.562ZM16.062 14.062C16.062 13.648 15.726 13.312 15.312 13.312C14.899 13.312 14.562 13.648 14.562 14.062H15.312H16.062ZM5.875 16.25V15.5C5.633 15.5 5.438 15.304 5.438 15.062H4.688H3.938C3.938 16.133 4.804 17 5.875 17V16.25ZM15.312 15.062H14.562C14.562 15.304 14.366 15.5 14.125 15.5V16.25V17C15.195 17 16.062 16.133 16.062 15.062H15.312ZM5.875 3.75V3C4.804 3 3.938 3.867 3.938 4.938H4.688H5.438C5.438 4.696 5.633 4.5 5.875 4.5V3.75ZM15.312 4.938H16.062C16.062 3.867 15.195 3 14.125 3V3.75V4.5C14.366 4.5 14.562 4.696 14.562 4.938H15.312ZM4.688 4.938H3.938V15.062H4.688H5.438V4.938H4.688ZM15.312 4.938H14.562V5.938H15.312H16.062V4.938H15.312ZM15.312 15.062H16.062V14.062H15.312H14.562V15.062H15.312ZM14.125 3.75V3H7.188V3.75V4.5H14.125V3.75ZM7.188 3.75V3H5.875V3.75V4.5H7.188V3.75ZM14.125 16.25V15.5H7.188V16.25V17H14.125V16.25ZM7.188 16.25V15.5H5.875V16.25V17H7.188V16.25ZM7.188 3.75H6.438V16.25H7.188H7.938V3.75H7.188Z" fill="currentColor" />
    <path d="M15.625 9.768H9.062M11.956 6.875L9.062 9.768L11.956 12.66" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
  </>,
